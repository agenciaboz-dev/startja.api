...
import { LoginForm, NewCompany, NewNature, NewNota, NewProduct, NewProperty, NewRule, NewUser } from "../definitions/userOperations"
...
export const handleSocket = (socket: Socket) => {
    ...
    socket.on("customer:signup", (data: NewUser) => customer.handleSignup(socket, data))
